...
abstract public class Image extends Model implements PropertyChangeListener
{
     ...
     * @throws IOException
     */
    public Image(ImageKey key, SmallBodyModel smallBodyModel) throws FitsException, IOException
    {
        this.key = key;
        this.smallBodyModel = smallBodyModel;
        downloadFilesIntoCache();
        initialize();
    }
     ...
     * @throws IOException
     */
    public Image(File fitFile, SmallBodyModel smallBodyModel, ImageSource source) throws FitsException, IOException
    {
        this.key = new ImageKey(null, source);
        this.smallBodyModel = smallBodyModel;
        initializeFilePaths(fitFile);
        initialize();
    }
    ...
    private void initialize() throws FitsException, IOException
    {
        ...
        maskSource.FillBox(getLeftMask(), IMAGE_WIDTH-1-getRightMask(), getBottomMask(), IMAGE_HEIGHT-1-getTopMask());
        maskSource.Update();
