...
public class MSIImage extends Model implements PropertyChangeListener
{
	...
	// If true, then the footprint is downloaded from the server. This setting is used by the GUI.
	// If false, then the footprint is generated by intersecting a frustum with the asteroid. This
	// latter setting is used when generating the files on the server.
	private static boolean downloadFootprint = false;
	...
	public static void setDownloadFootprint(boolean b)
	{
	    downloadFootprint = b;
	}
