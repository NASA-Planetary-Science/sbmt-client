...
public interface ModelNames
{
    ...
    static public final String POLYGON_STRUCTURES = "polygon-structures";
    ...
    static public final String LIDAR_BROWSE = "lidar-browse";
    static public final String LIDAR_SEARCH = "lidar-search";
