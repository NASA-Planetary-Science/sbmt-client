...
public class ResampleLowResColoringData
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        SmallBodyModel modelLow = new Eros(ModelConfig.getModelConfig(ShapeModelBody.EROS, ShapeModelAuthor.GASKELL));
        //SmallBodyModel modelLow = new Itokawa();
        modelLow.setModelResolution(0);

        // Load in the high res model
        SmallBodyModel modelHigh = new Eros(ModelConfig.getModelConfig(ShapeModelBody.EROS, ShapeModelAuthor.GASKELL));
