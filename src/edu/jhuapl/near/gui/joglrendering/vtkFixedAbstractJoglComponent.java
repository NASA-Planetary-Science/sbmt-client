 ...
 */
public class vtkFixedAbstractJoglComponent<T extends java.awt.Component> extends vtkAbstractComponent<T> {
  ...
  public vtkFixedAbstractJoglComponent(vtkRenderWindow renderWindowToUse, T glContainer) {
    ...
    this.glEventListener = new GLEventListener() {
      public void init(GLAutoDrawable drawable) {
        vtkFixedAbstractJoglComponent.this.isWindowCreated = true;
        ...
        vtkFixedAbstractJoglComponent.this.glRenderWindow.SetMapped(1);
        vtkFixedAbstractJoglComponent.this.glRenderWindow.SetPosition(0, 0);
        vtkFixedAbstractJoglComponent.this.setSize(drawable.getSurfaceWidth(), drawable.getSurfaceHeight());
        vtkFixedAbstractJoglComponent.this.glRenderWindow.OpenGLInit();
      }

      public void reshape(GLAutoDrawable drawable, int x, int y, int width, int height) {
        vtkFixedAbstractJoglComponent.this.setSize(width, height);
      }

      public void display(GLAutoDrawable drawable) {
        vtkFixedAbstractJoglComponent.this.inRenderCall = true;
        vtkFixedAbstractJoglComponent.this.glRenderWindow.Render();
        vtkFixedAbstractJoglComponent.this.inRenderCall = false;
      }

      public void dispose(GLAutoDrawable drawable) {
        vtkFixedAbstractJoglComponent.this.Delete();
