...
public class NLRPlot2 extends JFrame implements ChartMouseListener
{
    ...
    public NLRPlot2(NLRSearchDataCollection2 nlrModel, int trackId)
    {
...
//                  xyDataset, true, true, false);
    ...
    private void updateData(int trackId)
    {
        ...
        nlrModel.getPotentialVsDistance(trackId, potential, distance);
        ...
        nlrModel.getPotentialVsTime(trackId, potential, time);
