...
import edu.jhuapl.near.model.ImageCube.NoOverlapException;
...
public class ImageCubePopupMenu extends PopupMenu
{
            ...
            double[] pickedPosition)
    {
        if (pickedProp instanceof vtkActor)
        {
            ...
            {
                ImageCube image = imageCollection.getImage((vtkActor)pickedProp);
                setCurrentImage(image.getImageCubeKey());
