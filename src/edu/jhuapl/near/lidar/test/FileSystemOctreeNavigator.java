...
public class FileSystemOctreeNavigator
{
    Path rootDirectory;
    ...
    class SimpleFileSystemOctreeNode extends BoundingBox {
        ...
        public SimpleFileSystemOctreeNode(SimpleFileSystemOctreeNode parent, int whichChild)  // this constructor is for creating child nodes
        {
            ...
            this.path=parent.path.resolve(String.valueOf(whichChild));
            isLeaf=true;
            setupDataFilePath();
        }

        private void setupDataFilePath() {
            dataFilePath=path.resolve("data");
        ...
        public boolean childExistsOnDisk(int whichChild) {
            return getChildPath(whichChild).toFile().exists();
        }

    }

    public FileSystemOctreeNavigator(Path rootDirectory, BoundingBox bbox)
    {
    ...
    public static void main(String[] args)
    {
        ...
        sw.start();
        FileSystemOctreeNavigator navigator=new FileSystemOctreeNavigator(rootDirectory, bbox);
