...
import edu.jhuapl.sbmt.image2.impl.RangeGetterVectorDoubleFactory;
...
//        setDisplayedImageRange(rawImage, new IntensityRange(0, 255));
		...
		array3D = new double[imageWidth][imageHeight][imageDepth];
		...
		for (int i=0; i<imageWidth; i++)
		{
			for (int j=0; j<imageHeight; j++)
			{
				...
				{
					array3D[i][j][k] = rawImage.GetScalarComponentAsDouble(i, j, 0, k);
