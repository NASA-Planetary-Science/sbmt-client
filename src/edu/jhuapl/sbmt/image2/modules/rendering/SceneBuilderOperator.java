...
public class SceneBuilderOperator extends BasePipelineOperator<Pair<List<SmallBodyModel>, List<RenderableImage>>, Pair<List<vtkActor>, List<ImageRenderables>>>
{
	...
	private void processImages()
	{
        try
		{
        	...
        	List<ImageRenderables> renderables = Lists.newArrayList();
        	for (RenderableImage image : renderableImages)
        		renderables.add(new ImageRenderables(image, smallBodyModels));
