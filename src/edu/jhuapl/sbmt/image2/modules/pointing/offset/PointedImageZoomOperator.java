...
//        {
            ...
            for (int i = 0; i < 3; i++)
            {
            	...
            	scState.spacecraftPosition[i] = surfacePoint[i] - range*origState.getBoresightDirection()[i] * zoomRatio;
            }
