...
public class PointedImageRotateTargetPixelDirToLocalOriginOperator extends BasePipelineOperator<Pair<SpacecraftPointingState, SpacecraftPointingDelta>, Pair<SpacecraftPointingState, SpacecraftPointingDelta>>
{
	...
	public void processData() throws IOException, Exception
	{
		...
		if (origState.targetPixelCoordinates[0] != Double.MAX_VALUE || origState.targetPixelCoordinates[1] != Double.MAX_VALUE)
		{
        ...
        double line = height - 1 - origState.targetPixelCoordinates[0];
        double sample = origState.targetPixelCoordinates[1];
        ...
        Vector3D spacecraftPositionVector = new Vector3D(origState.spacecraftPosition);
...
//        }
    ...
    {
    	double[] spacecraftPosition = origState.spacecraftPosition;
    	double[] frustum1 = origState.frustum1;
    	double[] frustum2 = origState.frustum2;
    	double[] frustum3 = origState.frustum3;
