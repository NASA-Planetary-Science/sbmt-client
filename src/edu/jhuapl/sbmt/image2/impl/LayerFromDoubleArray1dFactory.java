...
import edu.jhuapl.sbmt.image2.impl.LayerDoubleFactory.DoubleGetter1d;
...
public class LayerFromDoubleArray1dFactory extends LayerFromDoubleCollection1dFactory
{
    ...
    public Layer ofScalar(double[] array, int iSize, int jSize, ValidityCheckerDoubleFactory.ScalarValidityChecker checker)
    {
    ...
    public Layer ofScalar(double[] array, IJtoSingleIndex reIndexer, int iSize, int jSize, ValidityCheckerDoubleFactory.ScalarValidityChecker checker)
    {
        DoubleGetter1d doubleGetter = index -> {
            return array[index];
        };
    ...
    public Layer ofVector(double[] array, int iSize, int jSize, int kSize, ValidityCheckerDoubleFactory.ScalarValidityChecker checker)
    {
    ...
    public Layer ofVector(double[] array, IJKtoSingleIndex reIndexer, int iSize, int jSize, int kSize, ValidityCheckerDoubleFactory.ScalarValidityChecker checker)
    {
        DoubleGetter1d doubleGetter = index -> {
            return array[index];
        };
