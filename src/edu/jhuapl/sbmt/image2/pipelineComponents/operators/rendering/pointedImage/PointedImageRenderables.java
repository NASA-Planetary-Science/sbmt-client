...
//    private RenderablePointedImage image;
	...
	private Pair<vtkActor, vtkActor> processOfflimb(RenderablePointedImage renderableImage, List<vtkImageData> imageData) throws IOException, Exception
	{
		...
		Just.of(renderableImage)
			.operate(new OfflimbPlaneGeneratorOperators(offLimbFootprintDepth, smallBodyModels.get(0), boundingBox, pipeline.getFootprintPolyData().get(0).GetNumberOfPoints()))
