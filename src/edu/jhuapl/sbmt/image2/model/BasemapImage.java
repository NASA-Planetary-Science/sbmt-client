...
public class BasemapImage
{
	...
	private ImageSource pointingType;
	 ...
	 */
	public BasemapImage(String imageFilename, ImageSource pointingType, String imageDescription, String imageName,
			ImageType imageType)
	{
	...
	public static void initializeSerializationProxy()
	{
		InstanceGetter.defaultInstanceGetter().register(BASEMAP_IMAGE_KEY, (metadata) -> {
	        ...
	        ImageSource pointingType = ImageSource.valueFor(metadata.get(pointingTypeKey));
	        ...
	        if (pointingType == ImageSource.LOCAL_CYLINDRICAL)
	        {
	 ...
	 */
	public ImageSource getPointingType()
	{
		return pointingType;
	}
	...
	public static void main(String[] args) throws IOException
	{
		...
		BasemapImage image1 = new BasemapImage("phobos_cyl_dlr_control.jpg", ImageSource.LOCAL_CYLINDRICAL, "Stooke. P., Stooke Small Bodies Maps V3.0. MULTI-SA-MULTI-6-STOOKEMAPS-V3.0. NASA Planetary Data System, 2015." ,
		...
		BasemapImage image2 = new BasemapImage("PSP_007769_9010_IRB.png", ImageSource.LOCAL_PERSPECTIVE, "PSP_007769_9010_IRB (NASA/JPL-Caltech/UArizona)" ,
