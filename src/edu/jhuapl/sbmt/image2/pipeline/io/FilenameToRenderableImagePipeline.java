...
public class FilenameToRenderableImagePipeline
{
	...
	public FilenameToRenderableImagePipeline(String filename, ImageSource imageSource, SmallBodyViewConfig config, ImagingInstrument selectedInstrument) throws IOException, Exception
	{
	...
	public static FilenameToRenderableImagePipeline of(String filename, ImageSource imageSource, SmallBodyViewConfig config, ImagingInstrument selectedInstrument) throws IOException, Exception
	{
