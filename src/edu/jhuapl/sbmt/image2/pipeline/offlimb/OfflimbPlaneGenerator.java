...
import edu.jhuapl.sbmt.image2.pipeline.rendering.CameraOrientationPipeline;
...
public class OfflimbPlaneGenerator extends BasePipelineOperator<RenderablePointedImage, Pair<RenderablePointedImage, vtkPolyData>>
{
	...
	public OfflimbPlaneGenerator(double offLimbFootprintDepth, SmallBodyModel smallBodyModel, double[] boundingBox, int numberPoints)
	{
...
//        		new RenderablePointedImageFootprintGeneratorPipeline(renderableImage, List.of(smallBodyModel));
        int res = (int)Math.sqrt(numberPoints)*3;
