...
public class ColorImageFootprintGeneratorOperator extends BasePipelineOperator<RenderablePointedImage, Pair<vtkImageData, vtkPolyData>>
{
	...
	public void processData() throws IOException, Exception
	{
		...
		RenderablePointedImage redImage = inputs.get(0);
		RenderablePointedImage greenImage = inputs.get(1);
		RenderablePointedImage blueImage = inputs.get(2);

		List<vtkImageData> imageDatas = Lists.newArrayList();
		for (RenderablePointedImage image : inputs)
		{
