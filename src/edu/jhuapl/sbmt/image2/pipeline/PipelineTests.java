...
import edu.jhuapl.sbmt.image2.modules.io.builtIn.BuiltInOBJReader;
...
import edu.jhuapl.sbmt.image2.pipeline.active.VTKDebug;
...
//		VtkImageVtkMaskingOperator maskingOperator = new VtkImageVtkMaskingOperator(new int[] {0,0,0,0});
		VtkLayerPreview preview = new VtkLayerPreview("Test 1");
