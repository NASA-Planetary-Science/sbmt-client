...
public class SpectrumBoundsCalculator
{
    ...
    public static void main(String[] args) throws IOException {
        ...
        FileWriter fw;
        SpectrumInstrumentConfig spectrumConfig = (SpectrumInstrumentConfig)((SmallBodyViewConfig)body.getSmallBodyConfig()).getConfigForClass(SpectrumInstrumentConfig.class);
        //TODO FIX THIS
//        try
//        {
...
//                spectrafiles = instrument.getQueryBase().runQuery(FixedListSearchMetadata.of("Spectrum Search", "spectrumlist.txt", "spectra", baseDir, PointingSource.CORRECTED_SPICE)).getFetchedData();
//            }
//
//            int iFile = 0;
...
//                    OTESSpectrum spectrum = new OTESSpectrum(thisFileName, spectrumConfig.getHierarchicalSpectraSearchSpecification(), body.getBoundingBoxDiagonalLength(), instrument, true, false);
...
//                    OVIRSSpectrum spectrum = new OVIRSSpectrum(thisFileName, spectrumConfig.getHierarchicalSpectraSearchSpecification(), body.getBoundingBoxDiagonalLength(), instrument, true, false);
//                    spectrumRenderer = new AdvancedSpectrumRenderer(spectrum, body, false);
//                }
//
//
