...
//		List<Layer> updatedLayers = Lists.newArrayList();
		...
		PerspectiveImageMetadata image = new PerspectiveImageMetadata(fileName, ImageType.valueOf("LUKE_IMAGE"), PointingSource.GASKELL, pointingFileName, new double[] {});
...
//		IPipelinePublisher<Layer> layerPublisher = new Just<Layer>(updatedLayers.get(0));
		...
		renderableImages.get(0).setImageSource(PointingSource.GASKELL);
