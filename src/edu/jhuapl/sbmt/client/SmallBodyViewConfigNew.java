...
* to create).
*/
public class SmallBodyViewConfigNew extends BodyViewConfig
{
    static public SmallBodyViewConfigNew getSmallBodyConfig(ShapeModelBody name, ShapeModelAuthor author)
    {
        return (SmallBodyViewConfigNew)getConfig(name, author, null);
    }

    static public SmallBodyViewConfigNew getSmallBodyConfig(ShapeModelBody name, ShapeModelAuthor author, String version)
    {
        return (SmallBodyViewConfigNew)getConfig(name, author, version);
    }
    ...
    public static void initialize()
    {
        ...
        // Gaskell Eros
        SmallBodyViewConfigNew c = new SmallBodyViewConfigNew();
...
//            c.pathOnServer = "/NEWHORIZONS/CHARON/shape_res0.vtk.gz";
            ...
            SmallBodyViewConfigNew hydra = new SmallBodyViewConfigNew();
...
//            c.pathOnServer = "/NEWHORIZONS/NIX/shape_res0.vtk.gz";
    ...
    public SmallBodyViewConfigNew clone() // throws CloneNotSupportedException
    {
        SmallBodyViewConfigNew c = (SmallBodyViewConfigNew)super.clone();
