...
//            c.presentInMissions =
     ...
     */
    protected DBRunInfo[] createDbInfos(ShapeModelBody body, ShapeModelType author, Instrument instrument, ImageSource... sources)
    {
    ...
    protected DBRunInfo[] createDbInfos(Instrument instrument, ShapeModelBody body, String tablePrefix, String modelImageDir, ImageSource... sources)
    {
    ...
    protected String getPointingFileSuffix(ImageSource source)
    {
        String suffix;
        switch (source)
        {
