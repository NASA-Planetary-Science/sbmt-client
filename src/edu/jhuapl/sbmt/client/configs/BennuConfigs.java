...
//		buildEarthWGS84Config(configArray, publicOnly);
		...
		buildBennuSPC20181109bConfig(configArray, publicOnly);
		buildBennuSPC20181115Config(configArray, publicOnly);
		buildBennuSPC20181116Config(configArray, publicOnly);
		buildBennuSPC20181123bConfig(configArray, publicOnly);
		buildBennuSPC20181202Config(configArray, publicOnly);
		buildBennuSPC20181206Config(configArray, publicOnly);
		buildBennuSPC20181217Config(configArray, publicOnly);
		buildBennuSPC20181217PublicConfig(configArray, publicOnly);
		buildBennuSPC20181227Config(configArray, publicOnly);
		buildBennuSPC20181227PublicConfig(configArray, publicOnly);
		buildBennuSPC20190105Config(configArray, publicOnly);
		buildBennuSPC20190114Config(configArray, publicOnly);
		buildBennuSPC20190117Config(configArray, publicOnly);
		buildBennuSPC20190121Config(configArray, publicOnly);
		buildBennuSPC20190121PublicConfig(configArray, publicOnly);
		buildBennuSPC20190207aConfig(configArray, publicOnly);
		buildBennuSPC20190207bConfig(configArray, publicOnly);
		buildBennuSPC20190414Config(configArray, publicOnly);
		buildBennuSPC20190414PublicConfig(configArray, publicOnly);
		buildBennuSPC20190612Config(configArray, publicOnly);
		buildBennuSPC20190612PublicConfig(configArray, publicOnly);
		buildBennuSPC20190828Config(configArray, publicOnly);
		buildBennuSPC20190828PublicConfig(configArray, publicOnly);
		buildBennuSPC20191027Config(configArray, publicOnly);
		...
		buildBennuOLAV21PTMPublicConfig(configArray, publicOnly);
		buildBennuSPOV54Config(configArray, publicOnly);
		buildBennuSPOV54PublicConfig(configArray, publicOnly);

    }

	public static void buildEarthBlenderConfig(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
        //
...
//                QueryBase queryBase = new FixedListQuery(fileLocator.get(SBMTFileLocator.TOP_PATH).getLocation(""), fileLocator.get(SBMTFileLocator.GALLERY_FILE).getLocation(""));
	...
	public static void buildEarthWGS84Config(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		//
...
//        configArray.add(c);
	...
	public static void buildBennuNolanConfig(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
        BennuConfigs c = new BennuConfigs();
	...
	public static void buildBennuV3GaskellConfig(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
	...
	public static void buildBennuV4GaskellConfig(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		 BennuConfigs c = new BennuConfigs();
...
//                         new GenericPhpQuery(c.rootDirOnServer + "/mapcam", "RQ36V4_MAP", c.rootDirOnServer + "/mapcam/gallery"),
	...
	public static void buildBennuSPC20181109bConfig(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
	...
	public static void buildBennuSPC20181115Config(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
...
//                        new GenericPhpQuery(c.rootDirOnServer + "/mapcam", "bennu_altwgspcv20181109b_mapcam", "bennu_altwgspcv20181109b_mapcam", c.rootDirOnServer + "/mapcam/gallery"),
	...
	public static void buildBennuSPC20181116Config(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
...
//                        new GenericPhpQuery(c.rootDirOnServer + "/mapcam", "bennu_altwgspcv20181116_mapcam", "bennu_altwgspcv20181116_mapcam", c.rootDirOnServer + "/mapcam/gallery"),
	...
	public static void buildBennuSPC20181123bConfig(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
...
//                        new GenericPhpQuery(c.rootDirOnServer + "/mapcam", "bennu_altwgspcv20181123b_mapcam", "bennu_altwgspcv20181123b_mapcam", c.rootDirOnServer + "/mapcam/gallery"),
	...
	public static void buildBennuSPC20181202Config(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
...
//                        new GenericPhpQuery(c.rootDirOnServer + "/mapcam", "bennu_altwgspcv20181202_mapcam", "bennu_altwgspcv20181202_mapcam", c.rootDirOnServer + "/mapcam/gallery"),
	...
	public static void buildBennuSPC20181206Config(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
...
//                        new GenericPhpQuery(c.rootDirOnServer + "/mapcam", "bennu_altwgspcv20181206_mapcam", "bennu_altwgspcv20181206_mapcam", c.rootDirOnServer + "/mapcam/gallery"),
	...
	public static void buildBennuSPC20181217Config(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
	...
	public static void buildBennuSPC20181217PublicConfig(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
        c.dataUsed = ShapeModelDataUsed.IMAGE_BASED;
        c.author = ShapeModelType.ALTWG_SPC_v20181217;
	...
	public static void buildBennuSPC20181227Config(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
        c.dataUsed = ShapeModelDataUsed.IMAGE_BASED;
	...
	public static void buildBennuSPC20181227PublicConfig(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
        c.dataUsed = ShapeModelDataUsed.IMAGE_BASED;
        c.author = ShapeModelType.ALTWG_SPC_v20181227;
	...
	public static void buildBennuSPC20190105Config(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
        c.dataUsed = ShapeModelDataUsed.IMAGE_BASED;
	...
	public static void buildBennuSPC20190114Config(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
        c.dataUsed = ShapeModelDataUsed.IMAGE_BASED;
	...
	public static void buildBennuSPC20190117Config(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
        c.dataUsed = ShapeModelDataUsed.IMAGE_BASED;
	...
	public static void buildBennuSPC20190121Config(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
        c.dataUsed = ShapeModelDataUsed.IMAGE_BASED;
	...
	public static void buildBennuSPC20190121PublicConfig(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
        c.dataUsed = ShapeModelDataUsed.IMAGE_BASED;
        c.author = ShapeModelType.ALTWG_SPC_v20190121;
	...
	public static void buildBennuSPC20190207aConfig(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
        c.dataUsed = ShapeModelDataUsed.IMAGE_BASED;
	...
	public static void buildBennuSPC20190207bConfig(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
        c.dataUsed = ShapeModelDataUsed.IMAGE_BASED;
	...
	public static void buildBennuSPC20190414Config(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
        c.dataUsed = ShapeModelDataUsed.IMAGE_BASED;
	...
	public static void buildBennuSPC20190414PublicConfig(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
        c.dataUsed = ShapeModelDataUsed.IMAGE_BASED;
        c.author = ShapeModelType.ALTWG_SPC_v20190414;
	...
	public static void buildBennuSPC20190612Config(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
        c.dataUsed = ShapeModelDataUsed.IMAGE_BASED;
	...
	public static void buildBennuSPC20190612PublicConfig(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
        c.dataUsed = ShapeModelDataUsed.IMAGE_BASED;
        c.author = ShapeModelType.ALTWG_SPO_v20190612;
	...
	public static void buildBennuSPC20190828Config(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
        c.dataUsed = ShapeModelDataUsed.IMAGE_BASED;
	...
	public static void buildBennuSPC20190828PublicConfig(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
        c.dataUsed = ShapeModelDataUsed.IMAGE_BASED;
        c.author = ShapeModelType.provide("ALTWG-SPC-v20190828");
	...
	public static void buildBennuSPC20191027Config(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
        c.dataUsed = ShapeModelDataUsed.IMAGE_BASED;
	...
	public static void buildBennuOLAV20Config(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
	...
	public static void buildBennuOLAV20PublicConfig(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
        c.dataUsed = ShapeModelDataUsed.LIDAR_BASED;
        c.author = ShapeModelType.provide("OLA-v20");
	...
	public static void buildBennuOLAV20PTMConfig(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
        c.dataUsed = ShapeModelDataUsed.LIDAR_BASED;
	...
	public static void buildBennuOLAV20PTMPublicConfig(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
        c.dataUsed = ShapeModelDataUsed.LIDAR_BASED;
        c.author = ShapeModelType.provide("OLA-v20-PTM");
	...
	private static void buildBennuOLAV21Config(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
	...
	private static void buildBennuOLAV21PublicConfig(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
	...
	private static void buildBennuOLAV21PTMConfig(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
        BennuConfigs c = new BennuConfigs();
	...
	private static void buildBennuOLAV21PTMPublicConfig(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
		if (!publicOnly) return;
	...
	private static void buildBennuSPOV54Config(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		BennuConfigs c = new BennuConfigs();
...
//        startStop.add(new GregorianCalendar(2019, 7, 6, 0, 0, 0).getTime());
	...
	private static void buildBennuSPOV54PublicConfig(ConfigArrayList<IBodyViewConfig> configArray, boolean publicOnly)
    {
		if (!publicOnly) return;
