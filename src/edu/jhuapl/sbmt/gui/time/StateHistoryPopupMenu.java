...
public class StateHistoryPopupMenu extends PopupMenu
{
     ...
     * mapped to Eros.
     */
    public StateHistoryPopupMenu(
            StateHistoryCollection runCollection,
...
//
    ...
    public void setCurrentRuns(List<StateHistoryKey> keys)
    {
        runKeys.clear();
        runKeys.addAll(keys);
    ...
    private void updateMenuItems()
    {
        ...
        for (StateHistoryKey imageKey : runKeys)
        {
    ...
    private class ShowInfoAction extends AbstractAction
    {
        public void actionPerformed(ActionEvent e)
        {
            StateHistoryKey selectedRunKey = null;
            for (StateHistoryKey runKey : runKeys)
            {
                if (mapRunMenuItem.isSelected())
                {
