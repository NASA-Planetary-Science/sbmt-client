...
public class SimulationRunImporterDialog extends javax.swing.JDialog
{
    ...
    public SimulationRunImporterDialog(java.awt.Window parent, boolean isEditMode)
    {
    ...
    public RunInfo getSimulationRunInfo()
    {
    ...
    {
        File file = SimulationRunFileChooser.showOpenDialog(this, "Select Simulation Run (.mission) File", "mission");
        if (file == null)
        {
            return;
        }
