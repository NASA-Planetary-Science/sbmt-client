...
public class ImagingHyperTreeSearchPanel extends javax.swing.JPanel implements PropertyChangeListener, TableModelListener, MouseListener, ListSelectionListener
{
    ...
    protected ImageSearchDataCollection imageModel;
    ...
    public ImagingHyperTreeSearchPanel(SmallBodyViewConfig smallBodyConfig,
    ...
    public ImagingHyperTreeSearchPanel init()
    {
        ...
        this.imageModel = (ImageSearchDataCollection)modelManager.getModel(getSearchImageCollectionModelName());
        imageModel.addDatasourceSkeleton("testHypertreeEros", "/Users/osheacm1/Documents/SAA/testHypertree/dataSource.image");
        imageModel.setCurrentDatasourceSkeleton("testHypertreeEros");
    ...
    protected ModelNames getSearchImageCollectionModelName()
    {
        return ModelNames.IMAGES_HYPERTREE_SEARCH;
    }
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {
        imageModel.removePropertyChangeListener(this);
        ...
        // read in the skeleton if it hasn't been read yet
...
//                cubeList = smallBodyModel.getIntersectingCubes(interiorPoly);
                ...
                BoundingBox polydataBB = new BoundingBox(interiorPoly.GetBounds());
                cubeList = ((ImageSearchDataCollection)imageModel).getLeavesIntersectingBoundingBox(polydataBB, new double[]{start, end});
            }
            else
            {
//                cubeList = smallBodyModel.getIntersectingCubes(region.interiorPolyData);
                BoundingBox polydataBB = new BoundingBox(region.interiorPolyData.GetBounds());
                cubeList = ((ImageSearchDataCollection)imageModel).getLeavesIntersectingBoundingBox(polydataBB, new double[]{start, end});
            }
        }
        else
...
//        cubeList = smallBodyModel.getIntersectingCubes(region.interiorPolyData);
        ...
        box.Update();
        cubeList = ((ImageSearchDataCollection)imageModel).getLeavesIntersectingBoundingBox(bbox, new double[]{start, end});
        }



//        String selectedSourceName = (String)sourceComboBox.getModel().getElementAt(sourceComboBox.getSelectedIndex());
//        System.out.println("Selected image source name: "+selectedSourceName);

//        System.out.println("Found matching image data path: " + imageDatasourcePath);
        imageModel.addPropertyChangeListener(this);
//                radialOffsetChanger.setModel(imageModel);
        //        radialOffsetChanger.setOffsetScale(imageModel.getOffsetScale());
        //        lidarPopupMenu = new LidarPopupMenu(imageModel, renderer);


//
//        Picker.setPickingEnabled(false);
//
//        imageModel.setParentForProgressMonitor(this);
