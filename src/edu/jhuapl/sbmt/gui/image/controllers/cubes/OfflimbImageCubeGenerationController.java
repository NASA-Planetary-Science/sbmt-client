...
import edu.jhuapl.sbmt.gui.image.ui.cubes.OfflimbImageCubeGenerationPanel;
...
public class OfflimbImageCubeGenerationController extends ImageCubeGenerationController
{
    ...
    {
        super.setupPanel();
        this.panel = new OfflimbImageCubeGenerationPanel();
        ((OfflimbImageCubeGenerationPanel)panel).getFootprintDepthSlider().addChangeListener(new ChangeListener()
        {
    ...
    {
        OfflimbImageCubeGenerationPanel specPanel = (OfflimbImageCubeGenerationPanel)panel;
