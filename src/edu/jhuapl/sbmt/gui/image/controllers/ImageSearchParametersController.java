...
import edu.jhuapl.sbmt.gui.image.panels.ImageSearchParametersPanel;
...
public class ImageSearchParametersController
{
    ...
    private ImageSearchParametersPanel panel;
    ...
    private void setupSearchParametersPanel()
    {
        ...
        JSpinner endSpinner = panel.getStartSpinner();
        ...
        JFormattedTextField fromPhaseTextField = panel.getToPhaseTextField();
        ...
        JFormattedTextField toEmissionTextField = panel.getToPhaseTextField();
        ...
        JFormattedTextField fromEmissionTextField = panel.getToPhaseTextField();
        ...
        JFormattedTextField toIncidenceTextField = panel.getToPhaseTextField();
        ...
        JFormattedTextField fromIncidenceTextField = panel.getToPhaseTextField();
        ...
        JFormattedTextField toResolutionTextField = panel.getToPhaseTextField();
        ...
        JFormattedTextField fromResolutionTextField = panel.getToPhaseTextField();
        ...
        JFormattedTextField toDistanceTextField = panel.getToPhaseTextField();
        ...
        JFormattedTextField fromDistanceTextField = panel.getToPhaseTextField();
        ...
        int numberOfFiltersActuallyUsed = model.getNumberOfFiltersActuallyUsed();
        System.out.println(
                "ImageSearchParametersController: setupSearchParametersPanel: filter check boxes length " + panel.getFilterCheckBoxes().length);
        System.out.println(
                "ImageSearchParametersController: setupSearchParametersPanel: number of filters used " + numberOfFiltersActuallyUsed);
        for (int i=panel.getFilterCheckBoxes().length-1; i>=0; --i)
        {
            if (numberOfFiltersActuallyUsed < i+1)
            {
                panel.getFilterCheckBoxes()[i].setSelected(false);
                panel.getFilterCheckBoxes()[i].setVisible(false);
            }
        }

        for (int i=0; i<panel.getFilterCheckBoxes().length; ++i)
        {
            if (numberOfFiltersActuallyUsed > i)
            {
                if (filterNames[i].startsWith("*"))
                {
                    panel.getFilterCheckBoxes()[i].setText(filterNames[i].substring(1));
                    panel.getFilterCheckBoxes()[i].setSelected(false);
                }
                else
                {
                    panel.getFilterCheckBoxes()[i].setText(filterNames[i]);
                }
            }
        }

        String[] userDefinedNames = smallBodyConfig.imageSearchUserDefinedCheckBoxesNames;
        int numberOfUserDefinedCheckBoxesActuallyUsed = model.getNumberOfUserDefinedCheckBoxesActuallyUsed();

        for (int i=panel.getUserDefinedCheckBoxes().length-1; i>=0; --i)
        {
            if (numberOfUserDefinedCheckBoxesActuallyUsed < i+1)
            {
                panel.getUserDefinedCheckBoxes()[i].setSelected(false);
                panel.getUserDefinedCheckBoxes()[i].setVisible(false);
            }
        }

        for (int i=0; i<panel.getUserDefinedCheckBoxes().length; ++i)
        {
            if (numberOfUserDefinedCheckBoxesActuallyUsed > i)
            {
                if (userDefinedNames[i].startsWith("*"))
                {
                    panel.getUserDefinedCheckBoxes()[i].setText(userDefinedNames[i].substring(1));
                    panel.getUserDefinedCheckBoxes()[i].setSelected(false);
                }
                else
                {
                    panel.getUserDefinedCheckBoxes()[i].setText(userDefinedNames[i]);
                }
            }
        }
