...
//            configArray.add(c);
        ...
        if (Configuration.isAPLVersion())
        {
            ...
            phobosMetadata = DataQuerySourcesMetadata.of("/phobos/ernst2018/imaging", "", null, null, "/phobos/ernst2018/imaging/gallery");
            setupFeatures(c);
            imagingConfig = (ImagingInstrumentConfig)c.getConfigForClass(ImagingInstrumentConfig.class);
            imagingConfig.imagingInstruments = Lists.newArrayList(
                    new ImagingInstrument( //
...
//            c.addFeatureConfig(BasemapImageConfig.class, new BasemapImageConfig(c));
            ...
            phobosMetadata = DataQuerySourcesMetadata.of("/phobos/ernst2018-megane/imaging", "", null, null, "/phobos/ernst2018-megane/imaging/gallery");
            imagingConfig = (ImagingInstrumentConfig)c.getConfigForClass(ImagingInstrumentConfig.class);
            imagingConfig.imagingInstruments = Lists.newArrayList(
                    new ImagingInstrument(
                            SpectralImageMode.MONO,
