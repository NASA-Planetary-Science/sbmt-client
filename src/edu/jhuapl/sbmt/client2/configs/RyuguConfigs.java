...
//            QueryBase queryBaseTir = new FixedListQuery(fileLocatorTir.get(SBMTFileLocator.TOP_PATH).getLocation("") + "/simulated", fileLocatorTir.get(SBMTFileLocator.GALLERY_FILE).getLocation(""));
            ...
            ImagingInstrument tir = setupImagingInstrument(bodyConfig, modelConfig, Instrument.TIR, queryBaseTir, new PointingSource[] { PointingSource.SPICE }, ImageType.TIR_IMAGE);

            QueryBase queryBase = new GenericPhpQuery("/ryugu/truth/onc", "ryugu_sim", "/ryugu/truth/onc/gallery");
            ImagingInstrument oncCam = setupImagingInstrument(bodyConfig, modelConfig, Instrument.ONC, queryBase, new PointingSource[] { PointingSource.SPICE }, ImageType.ONC_TRUTH_IMAGE, 90.0, "None");
...
//                    tir
        ...
        if (Configuration.isAPLVersion())
        {
            ...
            ImagingInstrument oncCam = setupImagingInstrument(bodyConfig, modelConfig, Instrument.ONC, queryBase, new PointingSource[] { PointingSource.GASKELL }, ImageType.ONC_IMAGE, 0.0, "None");
...
//                    tir
        ...
        if (Configuration.isAPLVersion())
        {
            ...
            ImagingInstrument oncCam = setupImagingInstrument(bodyConfig, modelConfig, Instrument.ONC, queryBase, new PointingSource[] { PointingSource.SPICE }, ImageType.ONC_IMAGE, 90.0, "None");
//            QueryBase tirQueryBase = new FixedListQuery("/ryugu/jaxa-sfm-v20180627/tir", "/ryugu/jaxa-sfm-v20180627/tir/gallery", false);
            ...
            ImagingInstrument tirCam = setupImagingInstrument(bodyConfig, modelConfig, Instrument.TIR, tirQueryBase, new PointingSource[] { PointingSource.SPICE }, ImageType.TIR_IMAGE);
            ...
            {
            	new DBRunInfo(PointingSource.SPICE, Instrument.ONC, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-sfm-v20180627/onc", "ryugu_jaxasfmv20180627", "ryugu/jaxa-sfm-v20180627/onc"),
            	new DBRunInfo(PointingSource.SPICE, Instrument.TIR, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-sfm-v20180627/tir", "ryugu_jaxasfmv20180627_tir", "ryugu/jaxa-sfm-v20180627/tir"),
            };
...
//            QueryBase tirQueryBase = new FixedListQuery("/ryugu/jaxa-sfm-v20180627/tir", "/ryugu/jaxa-sfm-v20180627/tir/gallery", false);
            ...
            c.databaseRunInfos = new DBRunInfo[]
            {
            	new DBRunInfo(PointingSource.SPICE, Instrument.ONC, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-sfm-v20180714/onc", "ryugu_jaxasfmv20180714", "ryugu/jaxa-sfm-v20180714/onc"),
            	new DBRunInfo(PointingSource.SPICE, Instrument.TIR, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-sfm-v20180714/tir", "ryugu_jaxasfmv20180714_tir", "ryugu/jaxa-sfm-v20180714/tir"),
            };
...
//            QueryBase tirQueryBase = new FixedListQuery("/ryugu/jaxa-sfm-v20180725-2/tir", "/ryugu/jaxa-sfm-v20180725-2/tir/gallery", false);
            ...
            c.databaseRunInfos = new DBRunInfo[]
            {
            	new DBRunInfo(PointingSource.SPICE, Instrument.ONC, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-sfm-v20180725-2/onc", "ryugu_jaxasfmv201807252", "ryugu/jaxa-sfm-v20180725-2/onc"),
            	new DBRunInfo(PointingSource.SPICE, Instrument.TIR, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-sfm-v20180725-2/tir", "ryugu_jaxasfmv201807252_tir", "ryugu/jaxa-sfm-v20180725-2/tir"),
            };
        ...
        if (Configuration.isAPLVersion())
        {
            ...
            ImagingInstrument oncCam = setupImagingInstrument(bodyConfig, modelConfig, Instrument.ONC, queryBase, new PointingSource[] { PointingSource.GASKELL, PointingSource.SPICE }, ImageType.ONC_IMAGE);
//            QueryBase tirQueryBase = new FixedListQuery("/ryugu/jaxa-sfm-v20180804/tir", "/ryugu/jaxa-sfm-v20180804/tir/gallery", false);
            ...
            c.databaseRunInfos = new DBRunInfo[]
            {
            	new DBRunInfo(PointingSource.SPICE, Instrument.ONC, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-sfm-v20180804/onc", "ryugu_jaxasfmv20180804", "ryugu/jaxa-sfm-v20180804/onc"),
            	new DBRunInfo(PointingSource.SPICE, Instrument.TIR, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-sfm-v20180804/tir", "ryugu_jaxasfmv20180804_tir", "ryugu/jaxa-sfm-v20180804/tir"),
            };
...
//            QueryBase tirQueryBase = new FixedListQuery("/ryugu/jaxa-spc-v20180705/tir", "/ryugu/jaxa-spc-v20180705/tir/gallery", false);
            ...
            c.databaseRunInfos = new DBRunInfo[]
            {
                	new DBRunInfo(PointingSource.SPICE, Instrument.ONC, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-spc-v20180705/onc", "ryugu_jaxaspcv20180705", "ryugu/jaxa-spc-v20180705/onc"),
                	new DBRunInfo(PointingSource.SPICE, Instrument.TIR, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-spc-v20180705/tir", "ryugu_jaxaspcv20180705_tir", "ryugu/jaxa-spc-v20180705/tir"),
            };
...
//            QueryBase tirQueryBase = new FixedListQuery("/ryugu/jaxa-spc-v20180717/tir", "/ryugu/jaxa-spc-v20180717/tir/gallery", false);
            ...
            c.databaseRunInfos = new DBRunInfo[]
            {
            	new DBRunInfo(PointingSource.SPICE, Instrument.ONC, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-spc-v20180717/onc", "ryugu_jaxaspcv20180717", "ryugu/jaxa-spc-v20180717/onc"),
            	new DBRunInfo(PointingSource.SPICE, Instrument.TIR, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-spc-v20180717/tir", "ryugu_jaxaspcv20180717_tir", "ryugu/jaxa-spc-v20180717/tir"),
            };
...
//            QueryBase tirQueryBase = new FixedListQuery("/ryugu/jaxa-spc-v20180719-2/tir", "/ryugu/jaxa-spc-v20180719-2/tir/gallery", false);
            ...
            c.databaseRunInfos = new DBRunInfo[]
            {
            	new DBRunInfo(PointingSource.SPICE, Instrument.ONC, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-spc-v20180719-2/onc", "ryugu_jaxaspcv201807192", "ryugu/jaxa-spc-v20180719-2/onc"),
            	new DBRunInfo(PointingSource.SPICE, Instrument.TIR, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-spc-v20180719-2/tir", "ryugu_jaxaspcv201807192_tir", "ryugu/jaxa-spc-v20180719-2/tir"),
            };
...
//            QueryBase tirQueryBase = new FixedListQuery("/ryugu/jaxa-spc-v20180731/tir", "/ryugu/jaxa-spc-v20180731/tir/gallery", false);
            ...
            c.databaseRunInfos = new DBRunInfo[]
            {
            	new DBRunInfo(PointingSource.SPICE, Instrument.ONC, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-spc-v20180731/onc", "ryugu_jaxaspcv20180731", "ryugu/jaxa-spc-v20180731/onc"),
            	new DBRunInfo(PointingSource.SPICE, Instrument.TIR, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-spc-v20180731/tir", "ryugu_jaxaspcv20180731_tir", "ryugu/jaxa-spc-v20180731/tir"),
            };
...
//            QueryBase tirQueryBase = new FixedListQuery("/ryugu/jaxa-spc-v20180810/tir", "/ryugu/jaxa-spc-v20180810/tir/gallery", false);
            ...
            c.databaseRunInfos = new DBRunInfo[]
            {
            	new DBRunInfo(PointingSource.SPICE, Instrument.ONC, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-spc-v20180810/onc", "ryugu_jaxaspcv20180810", "ryugu/jaxa-spc-v20180810/onc"),
            	new DBRunInfo(PointingSource.SPICE, Instrument.TIR, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-spc-v20180810/tir", "ryugu_jaxaspcv20180810_tir", "ryugu/jaxa-spc-v20180810/tir"),
            };
...
//            QueryBase tirQueryBase = new FixedListQuery("/ryugu/jaxa-spc-v20180816/tir", "/ryugu/jaxa-spc-v20180816/tir/gallery", false);
            ...
            c.databaseRunInfos = new DBRunInfo[]
            {
            	new DBRunInfo(PointingSource.SPICE, Instrument.ONC, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-spc-v20180816/onc", "ryugu_jaxaspcv20180816", "ryugu/jaxa-spc-v20180816/onc"),
            	new DBRunInfo(PointingSource.SPICE, Instrument.TIR, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-spc-v20180816/tir", "ryugu_jaxaspcv20180816_tir", "ryugu/jaxa-spc-v20180816/tir"),
            };
...
//            QueryBase tirQueryBase = new FixedListQuery("/ryugu/jaxa-spc-v20180829/tir", "/ryugu/jaxa-spc-v20180829/tir/gallery", false);
            ...
            c.databaseRunInfos = new DBRunInfo[]
            {
            	new DBRunInfo(PointingSource.SPICE, Instrument.ONC, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-spc-v20180829/onc", "ryugu_jaxaspcv20180829", "ryugu/jaxa-spc-v20180829/onc"),
            	new DBRunInfo(PointingSource.SPICE, Instrument.TIR, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-spc-v20180829/tir", "ryugu_jaxaspcv20180829_tir", "ryugu/jaxa-spc-v20180829/tir"),
            };
...
//            specIO.setPathString(c.spectrumMetadataFile);
            ...
            c.databaseRunInfos = new DBRunInfo[]
            {
            	new DBRunInfo(PointingSource.SPICE, Instrument.ONC, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-spc-v20181014/onc", "ryugu_jaxaspcv20181014", "ryugu/jaxa-spc-v20181014/onc"),
            	new DBRunInfo(PointingSource.SPICE, Instrument.TIR, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/jaxa-spc-v20181014/tir", "ryugu_jaxaspcv20181014_tir", "ryugu/jaxa-spc-v20181014/tir"),
            };
...
//            }
        ...
        if (Configuration.isAPLVersion())
        {
            ...
            ImagingInstrument oncCam = setupImagingInstrument(bodyConfig, modelConfig, Instrument.ONC, queryBase, new PointingSource[] { PointingSource.GASKELL }, ImageType.ONC_IMAGE);
...
//            c.timeHistoryFile = "/ryugu/nasa-001/history/timeHistory.bth"; // TODO move this to shared/timeHistory.bth
            ...
            c.databaseRunInfos = new DBRunInfo[]
            {
            	new DBRunInfo(PointingSource.SPICE, Instrument.ONC, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/nasa-001/onc", "ryugu_nasa001", "ryugu/nasa-001/onc"),
            	new DBRunInfo(PointingSource.SPICE, Instrument.TIR, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/nasa-001/tir", "ryugu_nasa001_tir", "ryugu/nasa-001/tir"),
            };
...
//            QueryBase tirQueryBase = new FixedListQuery("/ryugu/nasa-002/tir", "/ryugu/nasa-002/tir/gallery", false);            QueryBase tirQueryBase = new GenericPhpQuery("/ryugu/nasa-001/tir", "", "ryugu_nasa003_tir", "/ryugu/nasa-001/tir/gallery");
            ...
            ImagingInstrument oncCam = setupImagingInstrument(bodyConfig, modelConfig, Instrument.ONC, oncQueryBase, new PointingSource[] { PointingSource.GASKELL, PointingSource.SPICE }, ImageType.ONC_IMAGE);
            ImagingInstrument tirCam = setupImagingInstrument(bodyConfig, modelConfig, Instrument.TIR, tirQueryBase, new PointingSource[] { PointingSource.SPICE }, ImageType.TIR_IMAGE);
...
//            QueryBase tirQueryBase = new FixedListQuery("/ryugu/nasa-003/tir", "/ryugu/nasa-003/tir/gallery", false);
            ...
            c.databaseRunInfos = new DBRunInfo[]
            {
            	new DBRunInfo(PointingSource.SPICE, Instrument.ONC, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/nasa-003/onc", "ryugu_nasa003", "ryugu/nasa-003/onc"),
            	new DBRunInfo(PointingSource.SPICE, Instrument.TIR, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/nasa-003/tir", "ryugu_nasa003_tir", "ryugu/nasa-003/tir"),
            };
...
//            QueryBase tirQueryBase = new FixedListQuery("/ryugu/nasa-004/tir", "/ryugu/nasa-004/tir/gallery", false);
            ...
            c.databaseRunInfos = new DBRunInfo[]
            {
            	new DBRunInfo(PointingSource.SPICE, Instrument.ONC, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/nasa-004/onc", "ryugu_nasa004", "ryugu/nasa-004/onc"),
            	new DBRunInfo(PointingSource.SPICE, Instrument.TIR, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/nasa-004/tir", "ryugu_nasa004_tir", "ryugu/nasa-004/tir"),
            };
...
//            QueryBase tirQueryBase = new FixedListQuery("/ryugu/nasa-006/tir", "/ryugu/nasa-006/tir/gallery", false);
            ...
            c.databaseRunInfos = new DBRunInfo[]
            {
            	new DBRunInfo(PointingSource.SPICE, Instrument.ONC, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/nasa-006/onc", "ryugu_nasa006", "ryugu/nasa-006/onc"),
            	new DBRunInfo(PointingSource.SPICE, Instrument.TIR, ShapeModelBody.RYUGU.toString(), "/project/sbmt2/sbmt/data/bodies/ryugu/nasa-006/tir", "ryugu_nasa006_tir", "ryugu/nasa-006/tir"),
            };
    ...
    private static ImagingInstrument setupImagingInstrument(SBMTBodyConfiguration bodyConfig, ShapeModelConfiguration modelConfig, Instrument instrument, QueryBase queryBase, PointingSource[] imageSources, ImageType imageType, double rotation, String flip)
    {
        SBMTFileLocator fileLocator = SBMTFileLocators.of(bodyConfig, modelConfig, instrument, ".fits", ".INFO", ".SUM", ".jpeg");
    ...
    private static ImagingInstrument setupImagingInstrument(SBMTFileLocator fileLocator, SBMTBodyConfiguration bodyConfig, ShapeModelConfiguration modelConfig, Instrument instrument, QueryBase queryBase, PointingSource[] imageSources, ImageType imageType, double rotation, String flip)
    {
