			...
			TreeSet<Integer> cubeList) throws IOException, ParseException
	{
				...
				4*validDays.size() < cubeList.size())
		{
			...
			for (IdPair day : validDays)
			{
                ...
                Scanner filecubesScanner = new Scanner(filecubes);

                fileScanner.nextLine();
                fileScanner.nextLine();
                filecubesScanner.nextInt();
                filecubesScanner.nextInt();
                ...
                while (fileScanner.hasNext())
				{
                    ...
                    for (int i=0; i<19; ++i)
                    {
                        ...
                        {
                        case 4:
                            time = sdf.parse(fileScanner.next()).getTime();
                            break;
                        case 14:
                            point[0] = fileScanner.nextDouble()/1000.0;
                            break;
                        case 15:
                            point[1] = fileScanner.nextDouble()/1000.0;
                            break;
                        case 16:
                            point[2] = fileScanner.nextDouble()/1000.0;
                            break;
                        case 18:
                            potential = fileScanner.nextDouble();
                            break;
                        default:
                            fileScanner.next();
                            break;
                    ...
                    int cubeId = filecubesScanner.nextInt();
