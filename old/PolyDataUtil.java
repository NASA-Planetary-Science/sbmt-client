...
//	private static vtkPlane cutPlane2_f5;
//	private static vtkImplicitBoolean implicitBoolean_f5;
	private static vtkCutter cutPolyData_f5;
//	private static vtkPlane clipPlane1_f5;
//	private static vtkPlane clipPlane2_f5;
//	private static vtkClipPolyData clipPolyData1_f5;
//	private static vtkClipPolyData clipPolyData2_f5;
//	private static vtkPolyDataConnectivityFilter connectivityFilter_f5;
	private static vtkPolyData polyLine_f5;
	private static vtkExtractPolyDataGeometry extract1_f5;
	//private static vtkExtractGeometry extract1_f5;
...
//		normal[2] = -normal[2];
//
//		if (cutPlane2_f5 == null)
//			cutPlane2_f5 = new vtkPlane();
//		cutPlane2_f5.SetOrigin(pt1);
//		cutPlane2_f5.SetNormal(normal);
//
//		if (implicitBoolean_f5 == null)
//			implicitBoolean_f5 = new vtkImplicitBoolean();
//		implicitBoolean_f5.SetOperationTypeToIntersection();
//		implicitBoolean_f5.AddFunction(cutPlane_f5);
//		implicitBoolean_f5.AddFunction(cutPlane2_f5);
...
//		extract1_f5 = new vtkExtractGeometry();
		extract1_f5.SetImplicitFunction(cutPlane_f5);
		//extract1_f5.SetImplicitFunction(implicitBoolean_f5);
		extract1_f5.SetExtractInside(1);
		extract1_f5.SetExtractBoundaryCells(1);
//		extract1_f5.ExtractOnlyBoundaryCellsOn();
...
//		extract2_f5.Update();
		...
		System.out.println(extract1_f5.GetOutput().GetNumberOfCells());

		System.out.println("time to extract " + (System.currentTimeMillis()-t0));

		if (cutPolyData_f5 == null)
		{
			cutPolyData_f5 = new vtkCutter();
			//cutPolyData_f5.SetInput(polyData);
			cutPolyData_f5.SetInputConnection(extract1_f5.GetOutputPort());
