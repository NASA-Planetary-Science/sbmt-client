...
acc_x = -2.0000000000000000e+00*Const*( 1.0/( (a*a)-(c*c))*c*x/(a*a)-pow( (a*a)-(c*c),-(3.0/2.0))*x*asin(pow(( (a*a)-(c*c))/(a*a),(1.0/2.0))))
acc_y = 2.0000000000000000e+00*( pow( (a*a)-(c*c),-(3.0/2.0))*asin(pow(( (a*a)-(c*c))/(a*a),(1.0/2.0)))*y-1.0/( (a*a)-(c*c))*c/(a*a)*y)*Const
acc_z = Const*( 4.0000000000000000e+00*1.0/( (a*a)-(c*c))/c*z+(-4.0)*pow( (a*a)-(c*c),-(3.0/2.0))*asin(pow(( (a*a)-(c*c))/(a*a),(1.0/2.0)))*z)
