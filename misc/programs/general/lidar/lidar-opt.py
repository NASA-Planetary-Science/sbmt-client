...
def run_lidar_min(vtkfile, outputfile, inputfile):
...
for f in inputFiles:
    ...
    run_lidar_min(VTKFILE, output, INPUT)
...
run_lidar_compute_track_stats(VTKFILE, errorcombinedfile, inputOutputFiles)
