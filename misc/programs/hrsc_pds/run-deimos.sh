...
HRSC_DIR=/project/nearsdc/data/DEIMOS/IMAGING/hrsc
...
rm -rf $INFO_DIR
mkdir -p $INFO_DIR
echo ./create_info_files DEIMOS kernels.txt $HRSC_LABEL_FILES $INFO_DIR
./create_info_files DEIMOS kernels.txt $HRSC_LABEL_FILES $INFO_DIR
