...
{
	$deimosimages="deimosimages_pds";
	$deimoscubes="deimoscubes_pds";
}
else
{
	$deimosimages="deimosimages_gaskell";
	$deimoscubes="deimoscubes_gaskell";
}
...
$query = "SELECT DISTINCT filename, starttime FROM $deimosimages ";
if (strlen($cubesStr) > 0)
{
	$query .= " JOIN $deimoscubes ON $deimosimages.id = $deimoscubes.imageid ";
}
...
if (strlen($cubesStr) > 0)
{
	...
	$query .= " AND $deimoscubes.cubeid IN (";
