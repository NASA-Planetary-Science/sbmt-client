...
./run_java_program.sh edu.jhuapl.sbmt.model.spectrum.hypertree.SpectrumBoundsCalculator project/sbmt2/sbmt/data/servers/multi-mission/test/earth/osirisrex/otes/l2/otes_l2_bounds.txt /earth/osirisrex/otes/l2/infofiles-corrected OTES > calculateBounds.log
