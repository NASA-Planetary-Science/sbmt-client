...
./run_java_program.sh edu.jhuapl.sbmt.model.spectrum.hypertree.SpectrumBoundsCalculator /earth/osirisrex/otes/l2/otes_l2_bounds.txt /earth/osirisrex/otes/l2/infofiles-corrected/ > calculateBounds.log
