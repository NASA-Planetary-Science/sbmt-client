...
scp -p build/dist/internal/linux64/sbmt-${TODAYSDATE}-linux-x64.zip                    ${TARGET}/internal/releases/
scp -p build/dist/internal/mac64/sbmt-${TODAYSDATE}-macosx-x64.zip                     ${TARGET}/internal/releases/
scp -p build/dist/internal/win64/sbmt-${TODAYSDATE}-windows-x64.zip                    ${TARGET}/internal/releases/

scp -p build/dist/public/linux64/sbmt-${TODAYSDATE}-linux-x64.zip                     ${TARGET}/releases/
scp -p build/dist/public/mac64/sbmt-${TODAYSDATE}-macosx-x64.zip                      ${TARGET}/releases/
scp -p build/dist/public/win64/sbmt-${TODAYSDATE}-windows-x64.zip                     ${TARGET}/releases/
