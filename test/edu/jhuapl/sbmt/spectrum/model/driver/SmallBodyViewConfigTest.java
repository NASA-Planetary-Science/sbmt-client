...
public class SmallBodyViewConfigTest extends BodyViewConfig implements ISmallBodyViewConfig
{
    ...
    {
        return (SmallBodyViewConfigTest) getConfig(name, author, null);
    }

    static public SmallBodyViewConfigTest getSmallBodyConfig(ShapeModelBody name, ShapeModelType author, String version)
    {
        return (SmallBodyViewConfigTest) getConfig(name, author, version);
    }
    ...
    public static void initialize()
    {
        ...
        // Gaskell Eros
        SmallBodyViewConfigTest c = new SmallBodyViewConfigTest();
...
//            if ((SbmtTesterMultiMissionTool.getMission() == SbmtTesterMultiMissionTool.Mission.OSIRIS_REX) || (SbmtTesterMultiMissionTool.getMission() == SbmtTesterMultiMissionTool.Mission.OSIRIS_REX_DEPLOY) ||
//                    (SbmtTesterMultiMissionTool.getMission() == SbmtTesterMultiMissionTool.Mission.OSIRIS_REX_STAGE) || (SbmtTesterMultiMissionTool.getMission() == SbmtTesterMultiMissionTool.Mission.OSIRIS_REX_MIRROR_DEPLOY))
//            {
...
//            c.hierarchicalImageSearchSpecification = new PhobosExperimentalSearchSpecification();
        ...
        if (Configuration.isAPLVersion())
        {
            ...
            // this block so that Eclipse updates will continue to keep this code intact.
            // configArray.add(c);
            SmallBodyViewConfigTest callisto = new SmallBodyViewConfigTest();
            callisto = c.clone();
...
//           c.pathOnServer = "/NEWHORIZONS/CHARON/shape_res0.vtk.gz";
            ...
            SmallBodyViewConfigTest hydra = new SmallBodyViewConfigTest();
...
//            QueryBase tirQueryBase = new FixedListQuery("/ryugu/jaxa-sfm-v20180627/tir", "/ryugu/jaxa-sfm-v20180627/tir/gallery", false);
            ...
            switch (SbmtTesterMultiMissionTool.getMission())
            {
            case HAYABUSA2_DEV:
...
//            QueryBase tirQueryBase = new FixedListQuery("/ryugu/nasa-006/tir", "/ryugu/nasa-006/tir/gallery", false);
...

        {
            ...
            if (SbmtTesterMultiMissionTool.getMission() == SbmtTesterMultiMissionTool.Mission.NH_DEPLOY)
            {
                ViewConfig.setFirstTimeDefaultModelName(c.getUniqueName());
            }
    ...
    @Override
    public SmallBodyViewConfigTest clone() // throws CloneNotSupportedException
    {
        SmallBodyViewConfigTest c = (SmallBodyViewConfigTest) super.clone();
